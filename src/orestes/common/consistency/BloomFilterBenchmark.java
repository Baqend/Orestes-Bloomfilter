...
import orestes.common.consistency.BloomFilter.HashMethod;
...
//        BloomFilterMagnus<String> bf = new BloomFilterMagnus<String>(0.001, elementCount);
        ...
        System.out.println("p is " + bf.getFalsePositiveProbability(elementCount));
        System.out.println("m is " + bf.size());
